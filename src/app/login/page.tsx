...
export default function Login() {
  ...
  return (
    <main className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-sky-50 to-blue-100 overflow-hidden px-4 sm:px-6 lg:px-8 py-8">
      {/* Weather background */}
      <WeatherBackground />
      ...
      <form className="relative z-10 w-full max-w-md p-6 sm:p-8 mx-auto rounded-2xl shadow-xl bg-white/90 backdrop-blur-md border border-white/90 space-y-6 animate-fadeInUp">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-blue-800">Welcome Back</h1>
        ...
        <div className="flex items-center">
          ...
          <span className="mx-3 text-blue-400 text-xs sm:text-sm">or</span>
          <hr className="flex-grow border-blue-100" />
        </div>
        ...
        <div className="animate-fadeInUp" style={{animationDelay: "0.1s"}}>
          ...
          <div className={`relative transition-all duration-200 ${isFocused.email ? "transform scale-[1.01]" : ""}`}>
            <input
              ...
              required
              className="w-full px-4 py-2.5 sm:py-3 text-sm sm:text-base rounded-lg bg-white border border-blue-100 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-400 transition placeholder-blue-400/60 pr-10"
        ...
        <div className="animate-fadeInUp" style={{animationDelay: "0.2s"}}>
          ...
          <div className={`relative transition-all duration-200 ${isFocused.password ? "transform scale-[1.01]" : ""}`}>
            ...
            <button
              ...
              className="absolute right-10 top-1/2 transform -translate-y-1/2 text-blue-400 hover:text-blue-600 transition"
